...
'''-------------------------------------------HASTA ACA LLEGE CON LOS COMENTARIOS----------------------------------------------'''
...
# Representacion de valores: x, y, w, h, area por cada fila (componente) Explicacion de porque 50 y 200?
th_area_min = 50
th_area_max = 200
...
img = cv2.imread('TP_1/examen_3.png', cv2.IMREAD_GRAYSCALE)
